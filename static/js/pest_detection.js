(() => {
    ...
    els.diagnoseBtn.addEventListener('click', async () => {
        ...
        // Track the file before clearing state (for formData build)
        ...
        formData.append('query', query || 'Analyze this crop image for pests or diseases.');
        if (fileToSend) formData.append('crop_image', fileToSend);
